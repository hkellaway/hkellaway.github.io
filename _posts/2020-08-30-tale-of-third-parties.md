...
* Update your [Issue Template](https://github.com/hkellaway/Gloss/blob/main/.github/ISSUE_TEMPLATE/bug_report.md) and [Pull Request Template](https://github.com/hkellaway/Gloss/blob/main/PULL_REQUEST_TEMPLATE.md) to push people towards migrating
* Write a blog post :)
